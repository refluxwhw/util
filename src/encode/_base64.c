                               ...
                               const char *pLineSeparator)
{
    context->line_sep_len = snprintf(context->line_separator,
                                     sizeof(context->line_separator),
                                     "%s", pLineSeparator);
    if (context->line_sep_len >= (int)sizeof(context->line_separator))
    {
...
char *base64_encode_ex(struct base64_context *context, const char *src,
                       const int nSrcLen, char *dest, int *dest_len, const int bPad)
{
    int linePos;
    int leftover;
    int combined;
